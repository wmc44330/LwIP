...
__align(4) 
ETH_DMADESCTypeDef  DMARxDscrTab[ETH_RXBUFNB] __attribute__((at(0X68000000)));/* Ethernet Rx MA Descriptor */
__align(4) 
ETH_DMADESCTypeDef  DMATxDscrTab[ETH_TXBUFNB] __attribute__((at(0X68000140)));/* Ethernet Tx DMA Descriptor */
__align(4) 
uint8_t Rx_Buff[ETH_RXBUFNB][ETH_RX_BUF_SIZE] __attribute__((at(0X68000190))); /* Ethernet Receive Buffer */
__align(4) 
uint8_t Tx_Buff[ETH_TXBUFNB][ETH_TX_BUF_SIZE] __attribute__((at(0X680078A0))); /* Ethernet Transmit Buffer */
#else
__align(4) 
