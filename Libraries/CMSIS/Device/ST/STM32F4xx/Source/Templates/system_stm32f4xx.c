...
void SystemInit(void)
{
  /* FPU settings ------------------------------------------------------------*/
	...
	FPU->FPCCR &= ~(FPU_FPCCR_LSPEN_Msk | FPU_FPCCR_ASPEN_Msk);   /* clear LSPEN and ASPEN */
  #endif
...
/*
 ...
 | PD10 <-> FMC_D15 | PE11 <-> FMC_D8   | PF12 <-> FMC_A6 | PG10 <-> FMC_NE3 | 
...
#if defined(STM32F40_41xxx)
//  /* Configure and enable Bank1_SRAM2 */
//  FSMC_Bank1->BTCR[2]  = 0x00001011;	// Bank1_SRAM2 -->> BCR
//  FSMC_Bank1->BTCR[3]  = 0x00000201;    // Bank1_SRAM2 -->> BTR
//  FSMC_Bank1E->BWTR[2] = 0x0fffffff;  // 

  /* Configure and enable Bank1_SRAM3 */
  FSMC_Bank1->BTCR[4]  = 0x00001011;	// Bank1_SRAM3 -->> BCR
  FSMC_Bank1->BTCR[5]  = 0x00000800;    // Bank1_SRAM3 -->> BTR
  FSMC_Bank1E->BWTR[4] = 0x0fffffff;    // Bank1_SRAM3 -->> BWTR   
#endif  /* STM32F40_41xxx */
